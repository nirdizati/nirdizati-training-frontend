(function(){
  ...
  function PredictionMethodController($scope, LogsList, $cookies, $location, Prediction, LogsService, PredictionEvaluation, PredictionGeneral, $mdDialog, $cookieStore, googlechart) {
    ...
    $scope.types = {'time':'Remaining Time Predictions', 'workload':'Load Prediction', 'activity':'Next Activity Prediction', 'outcome':'Outcome Prediction'};
    $scope.selectedType = 0;

    var timeMethods = {'intercase':'Intercase Based Encoding', 'intracase':'Intracase Based Prediction'};
    ...
    $scope.updateMethods = function () {
      ...
      else if($scope.selectedType == "outcome") {
